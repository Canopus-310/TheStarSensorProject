...
DET_PATH = os.path.join(ROOT, "results", "detected_centroids.csv")
TRUTH_PATH = os.path.join(ROOT, "results", "catalog_sky_01_truth.csv")
IMG_PATH = os.path.join(ROOT, "results", "catalog_sky_01_linear16.png")
OUT_DIR = os.path.join(ROOT, "results", "debug_inspect")
...
print("Saved dists CSV to results/debug_inspect/dists_best_variant.csv")
