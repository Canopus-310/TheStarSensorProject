...
DET_IN = os.path.join(ROOT, "results", "detected_centroids.csv")
# if you previously used shifted file, change this to detected_centroids_shifted.csv
if not os.path.exists(DET_IN):
    DET_IN = os.path.join(ROOT, "results", "detected_centroids_shifted.csv")
DET_OUT = os.path.join(ROOT, "results", "detected_centroids_filtered.csv")
TRUTH = os.path.join(ROOT, "results", "catalog_sky_01_truth.csv")
IMG_PATH = os.path.join(ROOT, "results", "catalog_sky_01_linear16.png")
...
cmd = [
    ...
    "--det", DET_OUT,
    "--truth", TRUTH,
    "--out", os.path.join(ROOT, "results", "match_results_filtered.csv"),
    "--thresh", "8"
]
