...
ROOT = Path("..").resolve()
img_path = ROOT / "results" / "catalog_sky_01_linear16.png"
det_path = ROOT / "results" / "detected_centroids.csv"
truth_path = ROOT / "results" / "catalog_sky_01_truth.csv"
out_dir = ROOT / "results" / "debug_match"
