...
detf = "C:/Users/aryan/PycharmProjects/TheStarSensorProject/results_archived_2/detected_centroids.csv"
truthf = "C:/Users/aryan/PycharmProjects/TheStarSensorProject/results_archived_2/catalog_sky_01_truth.csv"
det = []
with open(detf) as f:
    r = csv.DictReader(f)
    for row in r:
...
if not matches:
    ...
    print("Saved results_archived_2/match_offsets.csv")
