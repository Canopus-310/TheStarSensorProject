...
DET = os.path.join(ROOT, "results_archived_2", "detected_centroids_shifted.csv")
TRUTH = os.path.join(ROOT, "results_archived_2", "catalog_sky_01_truth.csv")
OUT = os.path.join(ROOT, "results_archived_2", "nearest_dists_debug.csv")
...
print("Wrote nearest results_archived_2 to:", OUT)
